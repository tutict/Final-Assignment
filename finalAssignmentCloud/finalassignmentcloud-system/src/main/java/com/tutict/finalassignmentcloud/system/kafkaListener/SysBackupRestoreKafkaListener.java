package com.tutict.finalassignmentcloud.system.kafkaListener;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.tutict.finalassignmentcloud.entity.SysBackupRestore;
import com.tutict.finalassignmentcloud.system.service.SysBackupRestoreService;
...
public class SysBackupRestoreKafkaListener {
    ...
    public void onSysBackupRestoreCreateReceived(
            @Header(value = KafkaHeaders.RECEIVED_KEY, required = false) byte[] rawKey,
    ...
    public void onSysBackupRestoreUpdateReceived(
            @Header(value = KafkaHeaders.RECEIVED_KEY, required = false) byte[] rawKey,
            @Payload String message) {

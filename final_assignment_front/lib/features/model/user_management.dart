class UserManagement {
  ...
  static List<UserManagement> listFromJson(List<dynamic> json) {
    return json.map((value) => UserManagement.fromJson(value)).toList();
  }
  ...
  static Map<String, UserManagement> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json.isNotEmpty) {
      json.forEach((String key, dynamic value) =>
          map[key] = UserManagement.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of UserManagement-objects as value to a dart map
  static Map<String, List<UserManagement>> mapListFromJson(
      Map<String, dynamic> json) {
    var map = <String, List<UserManagement>>{};
    if (json.isNotEmpty) {
      json.forEach((String key, dynamic value) {
        map[key] = UserManagement.listFromJson(value);
      });
    }
    return map;
  }

import 'package:final_assignment_front/flutter_captcha_plus/captcha/click_word_captcha.dart';
import 'package:flutter/material.dart';

import 'package:final_assignment_front/flutter_captcha_plus/captcha/block_puzzle_captcha.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  List<DropdownMenuItem<int>> getListData() {
    ...
    DropdownMenuItem<int> dropdownMenuItem1 = DropdownMenuItem<int>(
      child: Text('滑动拼图'),
      value: 1,
    );
    items.add(dropdownMenuItem1);
    DropdownMenuItem<int> dropdownMenuItem2 = DropdownMenuItem<int>(
      child: Text('文字点选'),
      value: 2,
    );

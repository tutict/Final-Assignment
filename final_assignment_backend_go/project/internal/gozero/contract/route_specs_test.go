...
func TestRegisteredRouteSpecsIncludeAIContracts(t *testing.T) {
	...
	required := map[string]string{
		...
		"GET /api/rag/admin/documents/:documentId":    "RagManagementController",
		"PUT /api/rag/admin/documents/:documentId":    "RagManagementController",
		"POST /api/rag/admin/preview":                 "RagManagementController",

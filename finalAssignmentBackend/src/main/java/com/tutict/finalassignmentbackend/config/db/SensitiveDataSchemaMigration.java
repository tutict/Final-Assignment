...
import com.tutict.finalassignmentbackend.security.crypto.SensitiveDataCryptoService;
...
public class SensitiveDataSchemaMigration implements InitializingBean {
    ...
    public void afterPropertiesSet() {
        try (Connection connection = dataSource.getConnection()) {
            migrateTable(connection, "sys_user", "user_id", List.of(
                    new SensitiveColumn("id_card_number", "id_card_number_ciphertext",
                            "id_card_number_blind_index", "idx_sys_user_id_card_bidx"),
                    new SensitiveColumn("contact_number", "contact_number_ciphertext",
                            "contact_number_blind_index", "idx_sys_user_contact_bidx")
            ));

package com.tutict.finalassignmentbackend.service.admin;
...
public class SysRolePermissionService {
    ...
    @WsAction(service = "SysRolePermissionService", action = "checkAndInsertIdempotency", roles = {"SUPER_ADMIN", "ADMIN"})

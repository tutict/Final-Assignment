 ...
 * 这构成"refresh token at rest 的后量子加密"。对齐 Spring service/auth/PqcTokenCrypto。
 */
@ApplicationScoped
public class PqcTokenCrypto {
    ...
    @ConfigProperty(name = "jwt.ml-kem.private-key", defaultValue = "")
    String privateKeyPem;

    @ConfigProperty(name = "jwt.ml-kem.public-key", defaultValue = "")
    String publicKeyPem;

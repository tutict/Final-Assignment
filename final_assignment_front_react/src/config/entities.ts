...
import type { EntityConfigs } from './entityTypes';
...
const FINE_PAYMENT_STATUSES = ['Unpaid', 'Partial', 'Paid', 'Overdue', 'Waived'] as const;
  ...
  users: {
    ...
    fields: [
      ...
      // 用户账号状态，区别于驾驶证、车辆或角色状态
      {
        ...
        validation: {
          required: true,
          enum: Object.values(ROLES),          message: '请选择有效的用户角色',
        },
      },
